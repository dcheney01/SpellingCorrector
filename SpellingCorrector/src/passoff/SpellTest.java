...
public class SpellTest {
    ...
    private static final String WORD_FILENAME = "SpellingCorrector/word.txt";
    private static final String WORDS_FILENAME = "SpellingCorrector/words.txt";
    private static final String BIG_FILENAME = "SpellingCorrector/notsobig.txt";
